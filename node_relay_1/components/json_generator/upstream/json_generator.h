...
void json_gen_temp_humidity(json_gen_test_result_t *result, char *key_temp, float value_temp, char *key_humi, float value_humi, char *arr);
void json_gen_string_temp_humidity(json_gen_test_result_t *result, char *key_temp, char *value_temp, char *key_humi, char *value_humi, char *arr);
